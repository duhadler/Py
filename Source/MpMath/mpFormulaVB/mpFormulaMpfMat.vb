...
'      If TypeOf x Is mpf_mat_t Then
'        PyPtr = DirectCast(x, mpf_mat_t).PyPtr
'      Else
...
'    Public Shared Widening Operator CType(ByVal m1 As mpf_mat_t) As String
'      Return m1.Str()
'    End Operator
'
'
'    'Public Shared Narrowing Operator CType(ByVal s As String) As mpf_mat_t
'    Public Shared Widening Operator CType(ByVal s As String) As mpf_mat_t
'      Return New mpf_mat_t(s)
'    End Operator


'    Public Shared Narrowing Operator CType(ByVal m1 As mpf_mat_t) As Decimal
'      Return CDec(m1.Str())
'    End Operator
'
'    Public Shared Widening Operator CType(ByVal dec As Decimal) As mpf_mat_t
'      Return New mpf_mat_t(CStr(dec))
'    End Operator

    '  Public Shared Widening Operator CType(ByVal obj As Object) As mpf_mat_t
    '    Return New mpf_mat_t(obj)
    '  End Operator


'    Public Shared Narrowing Operator CType(ByVal m1 As mpf_mat_t) As Double
'      Return CDbl(m1.Str())
'    End Operator
'
'    Public Shared Widening Operator CType(ByVal d As Double) As mpf_mat_t
'      Return New mpf_mat_t(d)
'    End Operator


'    Public Shared Narrowing Operator CType(ByVal m1 As mpf_mat_t) As Long
'      Return CLng(m1.Str())
'    End Operator
'
'    Public Shared Widening Operator CType(ByVal si As Long) As mpf_mat_t
'      Return New mpf_mat_t(CStr(si))
'    End Operator



'    Public Shared Narrowing Operator CType(ByVal m1 As mpf_mat_t) As ULong
'      Return CULng(m1.Str())
'    End Operator
'
'    Public Shared Widening Operator CType(ByVal ui As ULong) As mpf_mat_t
'      Return New mpf_mat_t(CStr(ui))
'    End Operator



    Public Shared Operator =(ByVal m1 As mpf_mat_t, ByVal m2 As mpf_mat_t) As Boolean
      Return m1.PyPtr = m2.PyPtr
    End Operator


    Public Shared Operator =(ByVal m1 As mpf_mat_t, ByVal obj As Object) As Boolean
      Dim m2 As New mpf_mat_t(obj)
      Return m1.PyPtr = m2.PyPtr
    End Operator


    Public Shared Operator =(ByVal obj As Object, ByVal m1 As mpf_mat_t) As Boolean
      Dim m2 As New mpf_mat_t(obj)
    ...
    Public Shared Operator +(ByVal m1 As mpf_mat_t) As mpf_mat_t
      Dim m3 As New mpf_mat_t()
      m3.PyPtr = m1.PyPtr
      Return m3
    End Operator
    ...
    Public Shared Operator +(ByVal m1 As mpf_mat_t, ByVal m2 As mpf_mat_t) As mpf_mat_t
      Dim m3 As New mpf_mat_t()
      'MsgBox("Plus_mpf_mat_t")
      m3.PyPtr = m1.PyPtr + m2.PyPtr
      Return m3
    End Operator

    Public Shared Operator +(ByVal m1 As mpf_mat_t, ByVal obj As Object) As mpf_mat_t
      Dim m3 As New mpf_mat_t(obj)
      m3.PyPtr = m1.PyPtr + m3.PyPtr
      Return m3
    End Operator


    Public Shared Operator +(ByVal obj As Object, ByVal m1 As mpf_mat_t) As mpf_mat_t
      Dim m3 As New mpf_mat_t(obj)
      m3.PyPtr = m1.PyPtr + m3.PyPtr
      Return m3
    End Operator
    ...
    Public Shared Operator &(ByVal m1 As mpf_mat_t, ByVal s As String) As String
      Return m1.Str() & s
    End Operator


    Public Shared Operator &(ByVal s As String, ByVal m1 As mpf_mat_t) As String
      Return s & m1.Str()
    End Operator
    ...
    Public Shared Operator Mod(ByVal m1 As mpf_mat_t, ByVal m2 As mpf_mat_t) As mpf_mat_t
      Dim m3 As New mpf_mat_t()
    ...
    Public Shared Operator <<(ByVal m1 As mpf_mat_t, ByVal i As Integer) As mpf_mat_t
      Dim m3 As New mpf_mat_t()
    ...
    Public Shared Operator IsTrue(ByVal m1 As mpf_mat_t) As Boolean
    ...
    Public Shared Operator IsFalse(ByVal m1 As mpf_mat_t) As Boolean
      '    Return m1.PyPtr.Is_Zero <> 0
      Return True
    End Operator


    Public Shared Operator Not(ByVal m1 As mpf_mat_t) As Boolean
    ...
    Public Shared Operator And(ByVal m1 As mpf_mat_t, ByVal m2 As mpf_mat_t) As mpf_mat_t
      Dim m3 As New mpf_mat_t()
    ...
    Public Shared Operator Or(ByVal m1 As mpf_mat_t, ByVal m2 As mpf_mat_t) As mpf_mat_t
      Dim m3 As New mpf_mat_t()
    ...
    Public Shared Operator Xor(ByVal m1 As mpf_mat_t, ByVal m2 As mpf_mat_t) As mpf_mat_t
      Dim m3 As New mpf_mat_t()
